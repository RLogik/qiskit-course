...
def grover_algorithm(
    ...
    '''
    NOTE: This method was presented by Open HPI in the course Intrdocution to Quantum Computing (2022).
...
def random_satisfaction_problem(n: int, size: int = 0) -> list[int]:
    '''
    ...
    indexes = range(2**n);
    marked = np.random.choice(indexes, size=size, replace=False).tolist();
    return marked;
